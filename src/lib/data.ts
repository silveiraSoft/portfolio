...
export const SKILLS = [
  ...
  },
  {
    ...
    color: "violet",
    items: [
      { name: "Azure AD / Entra ID (MSAL.js)", level: 80 },
      { name: "OAuth 2.0 PKCE Flow", level: 82 },
      { name: "Client Credentials Flow (M2M)", level: 78 },
      { name: "Spring Security + JWT Validation", level: 88 },
      { name: "RBAC (Role-Based Access Control)", level: 85 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "MSAL.js (Microsoft Auth Library)", level: 78 },
  ...
  },
  {
    ...
    items: [
      ...
      { name: "Neon Serverless (PostgreSQL)", level: 75 },
      { name: "MySQL", level: 90 },
